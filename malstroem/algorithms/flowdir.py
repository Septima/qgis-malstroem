...
class Flowdir(MalstroemAlgorithm):
    ...
    def defineCharacteristics(self):
        ...
        self.name = self.tr('Calculate surface water flow directions')
    ...
    def processAlgorithm(self, progress):
        ...
        success = MalstroemUtils.runMalstroemCommand('flowdir', command_args, progress)
        if success:
            self.createOutput()
    ...
    def getCommand_args(self):
        ...
        command_args.extend(['-out', self.malstroem_outdir + '/flowdir.tif'])
        return command_args
