...
class Accum(MalstroemAlgorithm):
    ...
    def defineCharacteristics(self):
        ...
        self.name = self.tr('Calculate accumulated flow')
    ...
    def processAlgorithm(self, progress):
        ...
        success = MalstroemUtils.runMalstroemCommand('accum', command_args, progress)
        if success:
            self.createOutput()
    ...
    def getCommand_args(self):
        ...
        command_args.extend(['-flowdir', inputFilename])
        command_args.extend(['-out', self.malstroem_outdir + '/accum.tif'])
        return command_args
