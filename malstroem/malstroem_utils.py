...
class MalstroemUtils:
    ...
    @staticmethod
    def writeVectorOutput(malstroem_out_dir, malstroem_out_filename, output_filename):
        malstroem_out_vector_dir = os.path.join(malstroem_out_dir, 'vector')
        input_dataobject = dataobjects.getObjectFromUri(os.path.join(malstroem_out_vector_dir, malstroem_out_filename))
